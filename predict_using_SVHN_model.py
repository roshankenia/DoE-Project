...
def showbbox(model, img, imgNum, output_path):
    ...
    cv2.imwrite(os.path.join(output_path, str(imgNum)+"_prediction.jpg"), img)


# check the result
model = torch.load(r'./saved_model/SVHN_model_500_10epoch.pkl')
model.to(device)
